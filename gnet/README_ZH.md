...
- [x] 内置 bytes 内存池，由开源库 [bytebufferpool](https://learn/http/bytebufferpool) 提供支持
- [x] 整个生命周期是无锁的
- [x] 简单易用的 APIs
...
[![](https://opencollective.com/gnet/contributors.svg?width=890&button=false)](https://learn/http/gnet/graphs/contributors)
