...
func (r *Reader) readContinuedLineSlice(validateFirstLine func([]byte) error) ([]byte, error) {
	...
	// Read the first line.
	//fmt.Println("readContinuedLineSlice start")
	line, err := r.readLineSlice()
	if err != nil {
		return nil, err
	}
...
func (r *Reader) closeDot() {
	if r.dot == nil {
		//fmt.Printf("closeDot r.dot == nil:%v\n", r.dot == nil)
		return
	}
	//fmt.Printf("closeDot r.dot read\n")
	...
	for r.dot != nil {
		...
		r.dot.Read(buf)
		//fmt.Printf("closeDot r.dot read buf:%s\n", string(buf))
	}
}
